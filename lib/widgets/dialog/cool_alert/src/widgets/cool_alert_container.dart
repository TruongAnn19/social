...
import 'package:social_network/widgets/dialog/cool_alert/cool_alert.dart';
import 'package:social_network/widgets/dialog/cool_alert/src/constants/images.dart';
import 'package:social_network/widgets/dialog/cool_alert/src/models/cool_alert_options.dart';
import 'package:social_network/widgets/dialog/cool_alert/src/utils/single_loop_controller.dart';
import 'package:social_network/widgets/dialog/cool_alert/src/widgets/cool_alert_buttons.dart';
  ...
  Widget _buildText(context) {
    if (options!.text == null && options!.type != CoolAlertType.loading) {
      ...
      return Text(
        ...
        style: textNormal(Colors.blueGrey, 14),
      );
    }
  }
